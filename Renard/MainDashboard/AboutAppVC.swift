...
class AboutAppVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        options.append(aboutUsObject.init(section: "¿Por qué no puedo seleccionar imagenes HEIF?", content: ["Las imagenes HEIF ya tienen una compresión lo suficientemente eficiente como para reducir aún más su peso."]))
